...
export default function LoginPage() {
  ...
  const passwordError = touched && !password.trim() ? "Password wajib diisi" : null;
  ...
  function handleForgotPassword() {
    ...
    resetPassword.mutate(email, {
      onSuccess: () => toast.success("Link reset password sudah dikirim ke email kamu"),
    ...
    <div className="flex min-h-dvh flex-1 flex-col justify-center gap-8 bg-linear-to-b from-primary/25 via-secondary/10 to-background px-6 py-10">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Masuk untuk memilih aktivitas Beach &amp; Summer Wellbeing Day kamu.
        </p>
      </motion.div>
